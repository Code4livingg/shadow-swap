  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] font-['Inter',system-ui,sans-serif] text-white">
      ...
      <main className="overflow-x-hidden">
        {/* ── Hero ── */}
        <section className="relative flex min-h-screen items-center overflow-hidden px-6 py-20 pt-32 md:px-10 xl:px-16">
          {/* Background layers */}
          ...
          <div className="relative z-10 mx-auto grid w-full max-w-[1440px] gap-12 xl:grid-cols-[minmax(0,1.15fr)_minmax(360px,0.85fr)] xl:items-center">
            ...
            <div>
              ...
              <h1 className="text-5xl font-semibold leading-[0.96] tracking-[-0.06em] text-white md:text-7xl xl:text-[5.9rem]">
              ...
              <p className="mt-4 font-mono text-[11px] uppercase tracking-[0.24em] text-white/38">
                Animated benchmark counters for presentation. Live contract activity appears in the launch terminal.
              </p>
            </div>

            {/* Right column — illustrative preview card */}
              ...
              <div className="rounded-[30px] border border-teal-400/12 bg-[#0c1115]/90 p-5 shadow-[0_30px_100px_rgba(0,0,0,0.55)] backdrop-blur-xl">
                <div className="mb-4 flex items-center justify-between border-b border-white/8 pb-4">
                  <div>
                    ...
                    <h2 className="mt-2 text-xl font-semibold tracking-[-0.04em] text-white">Encrypted Market Surface</h2>
                  </div>
                  <div className="shrink-0 rounded-full border border-teal-400/15 bg-teal-400/10 px-3 py-1 font-mono text-[10px] uppercase tracking-[0.22em] text-teal-100/70">
                    preview
                  </div>
                </div>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="rounded-2xl border border-white/7 bg-white/[0.03] p-4">
                      ...
                      <strong className="mt-3 block text-base text-white">Matching before revelation</strong>
                      <span className="mt-2 block text-sm leading-6 text-white/55">Liquidity coordination without broadcasting visible order intent.</span>
                    </div>
                    <div className="rounded-2xl border border-white/7 bg-white/[0.03] p-4">
                      <p className="font-mono text-[11px] uppercase tracking-[0.24em] text-white/42">Settlement Layer</p>
                      <strong className="mt-3 block text-base text-white">Reveal execution only</strong>
                      <span className="mt-2 block text-sm leading-6 text-white/55">Only the final outcome becomes visible. Side, size, and route stay sealed.</span>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-4 flex gap-3">
                  <Link
                    className="flex-1 rounded-2xl bg-[#00d4aa] py-3 text-center text-sm font-semibold tracking-[0.16em] text-[#041512] no-underline transition-transform duration-200 hover:-translate-y-0.5"
                    to="/app"
                  >
                    Open Terminal
                  </Link>
                  <Link
                    className="flex-1 rounded-2xl border border-white/12 bg-white/[0.03] py-3 text-center text-sm font-semibold tracking-[0.16em] text-white no-underline transition-transform duration-200 hover:-translate-y-0.5"
                    to="/demo"
                  >
                    View Demo
                  </Link>
          ...
          <div className="mx-auto max-w-[1440px]">
            <div className="mb-10 max-w-3xl">
              ...
              <h2 className="mt-3 text-4xl font-semibold tracking-[-0.05em] text-white md:text-5xl">
                Encrypted coordination without pre-trade leakage
              </h2>
            </div>
